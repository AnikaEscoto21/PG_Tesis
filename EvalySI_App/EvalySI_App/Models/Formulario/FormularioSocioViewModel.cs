...
using EvalySI_App.Models.Proceso;
using EvalySI_App.Models.Socioeconomico;

namespace EvalySI_App.Models.Formulario
{
    public class FormularioSocioViewModel
    {
        ...
        public List<ObjetivoViewModel> Objetivos { get; set; } = new();
        public List<ReferenciaViewModel> Referencias { get; set; } = new();

        public SocioeconomicoViewModel? Socioeconomico { get; set; }

        public ProcesoSEViewModel? ProcesoSocioeconomico { get; set; }
        public ProcesoPoligrafoViewModel? ProcesoPoligrafo { get; set; }
    }
}
